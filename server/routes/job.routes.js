...
const { jobCreateSchema, jobUpdateSchema } = require('../validators/schemas');
...
router.route('/:id')
  ...
  .put(protect, authorize('recruiter'), validate(jobUpdateSchema), updateJob) // PUT update a job by ID (Recruiter only, owner only)
